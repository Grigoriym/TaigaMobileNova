...
fun getIssueDetailsData(issue: Issue = getIssueTask()): IssueDetailsData = IssueDetailsData(
    issue = issue,
...
fun getIssueTask(id: Long = getRandomLong()): Issue = Issue(
    id = id,
...
fun getComment(): Comment = Comment(
    ...
    postDateTime = getRandomLocalDateTime(),
    deleteDate = getRandomLocalDateTime(),
