...
include(":feature:filters:ui")
include(":feature:workitem:data")
include(":feature:tasks:ui")
include(":feature:profile:domain")
include(":feature:filters:mapper")
include(":feature:workitem:mapper")
include(":feature:users:mapper")
include(":feature:users:dto")
include(":feature:filters:dto")
include(":feature:workitem:dto")
include(":feature:projects:mapper")
include(":feature:projects:dto")
include(":feature:epics:dto")
include(":feature:epics:mapper")
include(":feature:userstories:mapper")
include(":feature:userstories:dto")
include(":feature:issues:dto")
