...
class ProfileViewModel @Inject constructor(
    ...
    val currentUserDTO = mutableResultFlow<UserDTO>()
    val currentUserStats = mutableResultFlow<Stats>()
    val currentUserProjects = mutableResultFlow<List<ProjectDTO>>()
    ...
    fun onOpen() = viewModelScope.launch {
        currentUserDTO.loadOrError { usersRepository.getUserDTO(userId) }
