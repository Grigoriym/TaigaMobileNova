...
class IssueDetailsViewModel(
    ...
    private val _state = MutableStateFlow(
        IssueDetailsState(
            ...
            toolbarTitle = NativeText.Arguments(
                stringResource = RString.issue_slug,
                args = listOf(ref)
            ),
    ...
    override fun onCleared() {
        ...
        logcat {
            "IssueDetailsViewModel cleared - session cleaned up for taskId: $issueId"
        }
    }
                ...
                .onSuccess { result ->
                    ...
                    _state.update {
                        it.copy(
                            ...
                            canDeleteIssue = result.canDeleteIssue,
                            canModifyIssue = result.canModifyIssue,
                    ...
                    setInitialDueDate(
                        ...
                        dueDateStatus = result.issue.dueDateStatus
                    )
                    setInitialAssignees(
