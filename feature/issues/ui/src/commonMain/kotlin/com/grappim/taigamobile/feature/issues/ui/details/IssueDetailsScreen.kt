...
import com.grappim.taigamobile.strings.generated.resources.delete_task_text
import com.grappim.taigamobile.strings.generated.resources.delete_task_title
...
fun IssueDetailsScreen(
    route: IssueDetailsNavDestination,
    ...
    viewModel: IssueDetailsViewModel = koinViewModel { parametersOf(route) }
) {
