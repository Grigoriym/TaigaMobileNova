...
class CustomFieldsMapper @Inject constructor(private val dateTimeUtils: DateTimeUtils) {
    ...
    fun toDomain(values: CustomAttributesValuesResponseDTO, resp: CustomAttributeResponseDTO): CustomField =
        CustomField(
            id = resp.id,
