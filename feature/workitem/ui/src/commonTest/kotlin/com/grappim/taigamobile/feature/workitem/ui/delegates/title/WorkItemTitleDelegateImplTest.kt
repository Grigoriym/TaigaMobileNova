...
class WorkItemTitleDelegateImplTest {
    ...
    private lateinit var sut: com.grappim.taigamobile.feature.workitem.ui.delegates.title.WorkItemTitleDelegateImpl
    ...
    @Before
    fun setup() {
        sut = _root_ide_package_.com.grappim.taigamobile.feature.workitem.ui.delegates.title.WorkItemTitleDelegateImpl(
