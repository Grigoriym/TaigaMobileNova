...
class TagsMapperTest {
    ...
    @Before
    fun setup() {
        sut = TagsMapper(testDispatcher)
    }

    @Test
    fun `toTags should map list of tags correctly`() = runTest {
    ...
    @Test
    fun `toTags should return empty list for null input`() = runTest {
    ...
    @Test
    fun `toTags should return empty list for empty input`() = runTest {
    ...
    @Test
    fun `toTags should use default gray color when color is null`() = runTest {
        val tagName = getRandomString()
    ...
    @Test
    fun `toTags should use default gray color when color is empty`() = runTest {
        val tagName = getRandomString()
    ...
    @Test
    fun `toTags should use empty string when name is null`() = runTest {
        val tagColor = "#00FF00"
    ...
    @Test
    fun `toTags should handle empty inner list`() = runTest {
    ...
    @Test
    fun `toTags should map multiple tags correctly`() = runTest {
    ...
    @Test
    fun `toTags should handle list with only name`() = runTest {
        val tagName = getRandomString()
