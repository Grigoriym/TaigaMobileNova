...
fun NavController.navigateToProfileScreen(id: Long) = navigate("${Routes.profile}/$id")

typealias NavigateToWikiPage = (slug: String) -> Unit

fun NavController.navigateToWikiPageScreen(slug: String) = navigate("${Routes.wiki_page}/$slug")
