...
| Integration tests against a live Taiga instance | **Local coverage done (gregory, 2026-08-09) — tasks 1–4 of [docs/testing/integration-tests-plan.md](integration-tests-plan.md) complete: login, all 12 `XApi` read round-trips, one write round-trip (create+cleanup). Still a manually-triggered, env-var-gated `jvmTest`, not part of PR CI.** CI-hosted Taiga (task 5, a docker-compose stack in the CI workflow) is open but explicitly gated — do not start without asking; see [docs/issues/2026-08-08-integration-tests-live-taiga.md](../issues/2026-08-08-integration-tests-live-taiga.md) for the original investigation. |
